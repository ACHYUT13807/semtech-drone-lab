...
export function DroneIcon({ className = 'w-6 h-6' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 48 48" fill="none" stroke="currentColor" strokeWidth="1.5">
      ...
      <circle cx="38" cy="10" r="6" opacity="0.3"/>
      <circle cx="10" cy="38" r="6" opacity="0.3"/>
      <circle cx="38" cy="38" r="6" opacity="0.3"/>
      <line x1="14" y1="14" x2="20" y2="20"/>
      <line x1="34" y1="14" x2="28" y2="20"/>
      <line x1="14" y1="34" x2="20" y2="28"/>
      <line x1="34" y1="34" x2="28" y2="28"/>
      <rect x="18" y="18" width="12" height="12" rx="2" fill="currentColor" opacity="0.15"/>
